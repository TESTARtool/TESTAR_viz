...
baselineoracles = html.Div([
            html.Div([
            html.A(id='collapse-baseline-oracle-link',children='Collapse/Expand Base Line Oracle table:', n_clicks=0,n_clicks_timestamp=0, href="javascript:toggle1(document.getElementById('baseline-oracle-area'))" ),
            ...
            html.Button(id='apply-baseline-oracle_style-button', n_clicks=0, n_clicks_timestamp=0, children='Apply Style',
                            style={'display': 'inline-block'}),
