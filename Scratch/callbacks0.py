...
#hitsb1,timeb1
def loadgraph(hitsb0,timeb0, contents,
              #url,db,username,password,
              #screenshot,imageregex1,nodelabel,edgelabel,
              filename, date): #,screenshotregex1,screenshotregex2):
    ...
    password="";
    log=[]
    # screenshot=glob.image_element;
    # imageregex1=glob.screenshotregex;
    # nodelabel=glob.default_nodeelement;
    # edgelabel = glob.default_edgeelement;
