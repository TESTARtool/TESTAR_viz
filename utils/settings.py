...
port = 8050
## When True, the application shows debug information in the browser and the DASH call graph \anchor settingdebug
...
Threshold_E = 20000
## centrality nodes scope: list of all the labelV elements subject to the centrality calculation.
...
## value of the 'key' element in GraphMl that determines the type (vertex or edge) of the element.
# default is 'labelV'
label_nodeelement = 'labelV'
## value of the 'key' element in GraphMl that determines the type (vertex or edge) of the element.
# default is 'labelE'
...
baselineoracle_pass_cycle_states = {'border-width': 2, 'border-color': 'goldenrod', 'background-color': 'goldenrod',
                                    'border-style': 'dashed'}
## style of the nodes that are part of a prefix in a witness
baselineoracle_pass_prefix_states = {'border-width': 2, 'border-color': 'gold', 'background-color': 'gold',
                                     'border-style': 'dashed'}
## style of the edges that are part of a cycle in a witness
baseineoracle_pass_cycle_transitions = {'width': 4, 'line-style': 'dashed', 'line-color': 'goldenrod',
                                        'mid-target-arrow-color': 'goldenrod'}
## style of the edges that are part of a prefix in a witness
baselineoracle_pass_prefix_transitionss = {'width': 4, 'line-style': 'dashed', 'line-color': 'gold',
                                           'mid-target-arrow-color': 'gold'}
## style of the nodes that are part of a cycle in a counterexample
baselineoracle_fail_cycle_states = {'border-width': 2, 'border-color': 'deeppink', 'background-color': 'deeppink',
                                    'border-style': 'dashed'}
## style of the nodes that are part of a prefix in a counterexample
baselineoracle_fail_prefix_states = {'border-width': 2, 'border-color': 'plum', 'background-color': 'plum',
                                     'border-style': 'dashed'}
## style of the edges that are part of a cycle in a counterexample
baselineoracle_fail_cycle_transitions = {'width': 4, 'line-style': 'dashed', 'line-color': 'deeppink',
                                         'mid-target-arrow-color': 'deeppink'}
## style of the edges that are part of a prefix in a counterexample
baselineoracle_fail_prefix_transitions = {'width': 4, 'line-style': 'dashed', 'line-color': 'plum',
                                          'mid-target-arrow-color': 'plum'}
## style of the nodes that are part of a cycle in a witness
latestoracle_pass_cycle_states = {'border-width': 2, 'border-color': 'green', 'background-color': 'green',
                                  'border-style': 'dashed'}
## style of the nodes that are part of a prefix in a witness
latestoracle_pass_prefix_states = {'border-width': 2, 'border-color': 'lightgreen', 'background-color':
                                   'lightgreen', 'border-style': 'dashed'}
## style of the edges that are part of a cycle in a witness
latestoracle_pass_cycle_transitions = {'width': 4, 'line-style': 'dashed', 'line-color': 'green',
                                       'mid-target-arrow-color': 'green'}
## style of the edges that are part of a prefix in a witness
latestoracle_pass_prefix_transitions = {'width': 4, 'line-style': 'dashed', 'line-color': 'lightgreen',
                                        'mid-target-arrow-color': 'lightgreen'}
## style of the nodes that are part of a cycle in a counterexample
latestoracle_fail_cycle_states = {'border-width': 2, 'border-color': 'red', 'background-color': 'red',
                                  'border-style': 'dashed'}
## style of the nodes that are part of a prefix in a counterexample
latestoracle_fail_prefix_states = {'border-width': 2, 'border-color': 'brown', 'background-color': 'brown',
                                   'border-style': 'dashed'}
## style of the edges that are part of a cycle in a counterexample
latestoracle_fail_cycle_transitions = {'width': 4, 'line-style': 'dashed', 'line-color': 'red',
                                       'mid-target-arrow-color': 'red'}
## style of the edges that are part of a prefix in a counterexample
latestoracle_fail_prefix_transitions = {'width': 4, 'line-style': 'dashed', 'line-color': 'brown',
                                        'mid-target-arrow-color': 'brown'}
